...
<head>
    ...
    <title>Favorites | DishCovery</title>
...
<div class="main-content">
    <div class="container-fluid pt-2">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h4 class="text-white mb-0">My Favorites</h4>
            <span class="badge bg-light text-dark"><?php echo count($bookmarks); ?> saved</span>
        </div>
                        ...
                        <div class="recipe-card listing-card h-100" data-id="<?php echo (int)$recipe['recipe_id']; ?>" role="link" tabindex="0" aria-label="View <?php echo htmlspecialchars($recipe['recipe_name']); ?> recipe details">
                            ...
                            <div class="recipe-body">
                                ...
                                <div class="small text-light">
                                    <span class="me-2"><?php echo (int)($recipe['calories'] ?? 0); ?> kcal</span>
                                    <span><?php echo (int)($recipe['cooking_time'] ?? 0); ?> mins</span>
                                </div>
                            </div>
                        </div>
                    </div>
